...
const setupCard = (el, currentTime, nextTime, resetTime) => {
  ...
  const cardFaceFront = el.querySelector('.card-face_front');
  const cardFaceBack = el.querySelector('.card-face_back');
...
const startCountdown = () => {
  /*Cada segundo llamamos a la funcion countdown. 1000 son milisegundos = 1sg*/
